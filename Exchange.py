...
class TExchange(GeneratedsSuper):
    ...
    def validate_inputGroupType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on inputGroupType' % {"value": value, "lineno": lineno} )
                result = False
            if value > 5:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on inputGroupType' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_outputGroupType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on outputGroupType' % {"value": value, "lineno": lineno} )
                result = False
            if value > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on outputGroupType' % {"value": value, "lineno": lineno} )
                result = False
        return result
    ...
    def validate_CASNumberType1(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) != 11:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd length restriction on CASNumberType1' % {"value": encode_str_2_3(value), "lineno": lineno} )
                result = False
            if not self.gds_validate_simple_patterns(
                    self.validate_CASNumberType1_patterns_, value):
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_CASNumberType1_patterns_, ))
    ...
    def validate_TRegionalCode(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 7:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on TRegionalCode' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    ...
    def validate_uncertaintyTypeType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on uncertaintyTypeType' % {"value": value, "lineno": lineno} )
                result = False
            if value > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on uncertaintyTypeType' % {"value": value, "lineno": lineno} )
                result = False
    ...
    def validate_TString30(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 30:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on TString30' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    ...
    def _hasContent(self):
        if (
            self.inputGroup is not None or
            self.outputGroup is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:es="http://www.EcoInvent.org/EcoSpold01" xmlns:None="http://www.EcoInvent.org/EcoSpold01" ', name_='TExchange', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TExchange')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TExchange', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TExchange'):
        ...
        if self.meanValue is not None and 'meanValue' not in already_processed:
            ...
            outfile.write(' meanValue="%s"' % self.gds_format_double(self.meanValue, input_name='meanValue'))
        if self.uncertaintyType is not None and 'uncertaintyType' not in already_processed:
            already_processed.add('uncertaintyType')
            outfile.write(' uncertaintyType="%s"' % self.gds_format_integer(self.uncertaintyType, input_name='uncertaintyType'))
        if self.standardDeviation95 is not None and 'standardDeviation95' not in already_processed:
            already_processed.add('standardDeviation95')
            outfile.write(' standardDeviation95="%s"' % self.gds_format_double(self.standardDeviation95, input_name='standardDeviation95'))
        ...
        if self.referenceToSource is not None and 'referenceToSource' not in already_processed:
            already_processed.add('referenceToSource')
            outfile.write(' referenceToSource="%s"' % self.gds_format_integer(self.referenceToSource, input_name='referenceToSource'))
        ...
        if self.mostLikelyValue is not None and 'mostLikelyValue' not in already_processed:
            already_processed.add('mostLikelyValue')
            outfile.write(' mostLikelyValue="%s"' % self.gds_format_double(self.mostLikelyValue, input_name='mostLikelyValue'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:es="http://www.EcoInvent.org/EcoSpold01" xmlns:None="http://www.EcoInvent.org/EcoSpold01" ', name_='TExchange', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.inputGroup is not None:
            namespaceprefix_ = self.inputGroup_nsprefix_ + ':' if (UseCapturedNS_ and self.inputGroup_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinputGroup>%s</%sinputGroup>%s' % (namespaceprefix_ , self.gds_format_integer(self.inputGroup, input_name='inputGroup'), namespaceprefix_ , eol_))
        if self.outputGroup is not None:
            namespaceprefix_ = self.outputGroup_nsprefix_ + ':' if (UseCapturedNS_ and self.outputGroup_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%soutputGroup>%s</%soutputGroup>%s' % (namespaceprefix_ , self.gds_format_integer(self.outputGroup, input_name='outputGroup'), namespaceprefix_ , eol_))
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'uncertaintyType' not in already_processed:
            already_processed.add('uncertaintyType')
            self.uncertaintyType = self.gds_parse_integer(value, node, 'uncertaintyType')
            self.validate_uncertaintyTypeType(self.uncertaintyType)    # validate type uncertaintyTypeType
        ...
        if value is not None and 'standardDeviation95' not in already_processed:
            ...
            self.validate_TFloatNumber(self.standardDeviation95)    # validate type TFloatNumber
        ...
        if value is not None and 'referenceToSource' not in already_processed:
            already_processed.add('referenceToSource')
            self.referenceToSource = self.gds_parse_integer(value, node, 'referenceToSource')
            self.validate_TIndexNumber(self.referenceToSource)    # validate type TIndexNumber
        ...
        if value is not None and 'mostLikelyValue' not in already_processed:
            ...
            self.validate_TFloatNumber(self.mostLikelyValue)    # validate type TFloatNumber
