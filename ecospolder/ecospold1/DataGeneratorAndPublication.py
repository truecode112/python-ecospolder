...
class TDataGeneratorAndPublication(GeneratedsSuper):
    ...
    def validate_dataPublishedInType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on dataPublishedInType' % {"value": value, "lineno": lineno} )
                result = False
            if value > 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on dataPublishedInType' % {"value": value, "lineno": lineno} )
                result = False
    def validate_accessRestrictedToType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on accessRestrictedToType' % {"value": value, "lineno": lineno} )
                result = False
            if value > 3:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on accessRestrictedToType' % {"value": value, "lineno": lineno} )
                result = False
    def validate_TCompanyCode(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 7:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on TCompanyCode' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def validate_TISOCountryCode(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            value = value
            enumerations = ['AF', 'AL', 'DZ', 'AS', 'AD', 'AO', 'AI', 'AQ', 'AG', 'AR', 'AM', 'AW', 'AU', 'AT', 'AZ', 'BS', 'BH', 'BD', 'BB', 'BY', 'BE', 'BZ', 'BJ', 'BM', 'BT', 'BO', 'BA', 'BW', 'BV', 'BR', 'IO', 'BN', 'BG', 'BF', 'BI', 'KH', 'CM', 'CA', 'CV', 'KY', 'CF', 'TD', 'CL', 'CN', 'CX', 'CC', 'CO', 'KM', 'CG', 'CK', 'CR', 'CI', 'HR', 'CU', 'CY', 'CZ', 'DK', 'DJ', 'DM', 'DO', 'TP', 'EC', 'EG', 'SV', 'GQ', 'ER', 'EE', 'ET', 'FK', 'FO', 'FJ', 'FI', 'FR', 'FX', 'GF', 'PF', 'TF', 'GA', 'GM', 'GE', 'DE', 'GH', 'GI', 'GR', 'GL', 'GD', 'GP', 'GU', 'GT', 'GN', 'GW', 'GY', 'HT', 'HM', 'HN', 'HK', 'HU', 'IS', 'IN', 'ID', 'IR', 'IQ', 'IE', 'IL', 'IT', 'JM', 'JP', 'JO', 'KZ', 'KE', 'KI', 'KP', 'KR', 'KW', 'KG', 'LA', 'LV', 'LB', 'LS', 'LR', 'LY', 'LI', 'LT', 'LU', 'MO', 'MK', 'MG', 'MW', 'MY', 'MV', 'ML', 'MT', 'MH', 'MQ', 'MR', 'MU', 'YT', 'MX', 'FM', 'MD', 'MC', 'MN', 'MS', 'MA', 'MZ', 'MM', 'NA', 'NR', 'NP', 'NL', 'AN', 'NC', 'NZ', 'NI', 'NE', 'NG', 'NU', 'NF', 'MP', 'NO', 'OM', 'PK', 'PW', 'PA', 'PG', 'PY', 'PE', 'PH', 'PN', 'PL', 'PT', 'PR', 'QA', 'RE', 'RO', 'RU', 'RW', 'KN', 'LC', 'VC', 'WS', 'SM', 'ST', 'SA', 'SN', 'SC', 'SL', 'SG', 'SK', 'SI', 'SB', 'SO', 'ZA', 'ES', 'LK', 'SH', 'PM', 'SD', 'SR', 'SJ', 'SZ', 'SE', 'CH', 'SY', 'TW', 'TJ', 'TZ', 'TH', 'TG', 'TK', 'TO', 'TT', 'TN', 'TR', 'TM', 'TC', 'TV', 'UG', 'UA', 'AE', 'GB', 'US', 'UM', 'UY', 'UZ', 'VU', 'VA', 'VE', 'VN', 'VG', 'VI', 'WF', 'EH', 'YE', 'CS', 'CD', 'ZM', 'ZW']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on TISOCountryCode' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) != 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd length restriction on TISOCountryCode' % {"value": encode_str_2_3(value), "lineno": lineno} )
                result = False
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:es="http://www.EcoInvent.org/EcoSpold01"', name_='TDataGeneratorAndPublication', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TDataGeneratorAndPublication':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDataGeneratorAndPublication')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TDataGeneratorAndPublication', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDataGeneratorAndPublication'):
        ...
        if self.dataPublishedIn != 0 and 'dataPublishedIn' not in already_processed:
            ...
            outfile.write(' dataPublishedIn="%s"' % self.gds_format_integer(self.dataPublishedIn, input_name='dataPublishedIn'))
        if self.referenceToPublishedSource is not None and 'referenceToPublishedSource' not in already_processed:
            already_processed.add('referenceToPublishedSource')
            outfile.write(' referenceToPublishedSource="%s"' % self.gds_format_integer(self.referenceToPublishedSource, input_name='referenceToPublishedSource'))
        if self.copyright is not None and 'copyright' not in already_processed:
            already_processed.add('copyright')
            outfile.write(' copyright="%s"' % self.gds_format_boolean(self.copyright, input_name='copyright'))
        if self.accessRestrictedTo is not None and 'accessRestrictedTo' not in already_processed:
            already_processed.add('accessRestrictedTo')
            outfile.write(' accessRestrictedTo="%s"' % self.gds_format_integer(self.accessRestrictedTo, input_name='accessRestrictedTo'))
        if self.companyCode is not None and 'companyCode' not in already_processed:
            already_processed.add('companyCode')
            outfile.write(' companyCode=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.companyCode), input_name='companyCode')), ))
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:es="http://www.EcoInvent.org/EcoSpold01"', name_='TDataGeneratorAndPublication', fromsubclass_=False, pretty_print=True):
        pass
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'dataPublishedIn' not in already_processed:
            already_processed.add('dataPublishedIn')
            self.dataPublishedIn = self.gds_parse_integer(value, node, 'dataPublishedIn')
            self.validate_dataPublishedInType(self.dataPublishedIn)    # validate type dataPublishedInType
        ...
        if value is not None and 'referenceToPublishedSource' not in already_processed:
            already_processed.add('referenceToPublishedSource')
            self.referenceToPublishedSource = self.gds_parse_integer(value, node, 'referenceToPublishedSource')
            self.validate_TIndexNumber(self.referenceToPublishedSource)    # validate type TIndexNumber
        ...
        if value is not None and 'accessRestrictedTo' not in already_processed:
            already_processed.add('accessRestrictedTo')
            self.accessRestrictedTo = self.gds_parse_integer(value, node, 'accessRestrictedTo')
            self.validate_accessRestrictedToType(self.accessRestrictedTo)    # validate type accessRestrictedToType
        ...
        if value is not None and 'countryCode' not in already_processed:
            ...
            self.validate_TISOCountryCode(self.countryCode)    # validate type TISOCountryCode
