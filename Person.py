...
class TPerson(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TPerson)
    ...
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TPerson', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TPerson')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TPerson', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TPerson'):
        ...
        if self.telephone is not None and 'telephone' not in already_processed:
            ...
            outfile.write(' telephone=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.telephone), input_name='telephone')), ))
        if self.telefax is not None and 'telefax' not in already_processed:
            already_processed.add('telefax')
            outfile.write(' telefax=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.telefax), input_name='telefax')), ))
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='TPerson', fromsubclass_=False, pretty_print=True):
        pass
