...
class TDataSetInformation(GeneratedsSuper):
    ...
    def validate_typeType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on typeType' % {"value": value, "lineno": lineno} )
                result = False
            if value > 5:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on typeType' % {"value": value, "lineno": lineno} )
                result = False
    ...
    def validate_internalVersionType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_internalVersionType_patterns_, ))
    ...
    def validate_energyValuesType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minInclusive restriction on energyValuesType' % {"value": value, "lineno": lineno} )
                result = False
            if value > 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxInclusive restriction on energyValuesType' % {"value": value, "lineno": lineno} )
                result = False
    def validate_TISOLanguageCode(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            value = value
            enumerations = ['ab', 'aa', 'af', 'sq', 'am', 'ar', 'hy', 'as', 'ay', 'az', 'ba', 'eu', 'bn', 'dz', 'bh', 'bi', 'br', 'bg', 'my', 'be', 'km', 'ca', 'zh', 'co', 'hr', 'cs', 'da', 'nl', 'en', 'eo', 'et', 'fo', 'fa', 'fj', 'fi', 'fr', 'fy', 'gl', 'ka', 'de', 'el', 'kl', 'gn', 'gu', 'ha', 'iw', 'he', 'hi', 'hu', 'is', 'in', 'id', 'ia', 'ie', 'iu', 'ik', 'ga', 'it', 'ja', 'jw', 'kn', 'ks', 'kk', 'rw', 'ky', 'rn', 'ko', 'ku', 'lo', 'la', 'lv', 'ln', 'lt', 'mk', 'mg', 'ms', 'ml', 'mt', 'gv', 'mi', 'mr', 'mo', 'mn', 'na', 'ne', 'no', 'oc', 'or', 'om', 'ps', 'pl', 'pt', 'pa', 'qu', 'rm', 'ro', 'ru', 'sm', 'sg', 'sa', 'gd', 'sr', 'sh', 'st', 'tn', 'sn', 'sd', 'si', 'ss', 'sk', 'sl', 'so', 'es', 'su', 'sw', 'sv', 'tl', 'tg', 'ta', 'tt', 'te', 'th', 'bo', 'ti', 'to', 'ts', 'tr', 'tk', 'tw', 'ug', 'uk', 'ur', 'uz', 'vi', 'vo', 'cy', 'wo', 'xh', 'ji', 'yi', 'yo', 'zu']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on TISOLanguageCode' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) != 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd length restriction on TISOLanguageCode' % {"value": encode_str_2_3(value), "lineno": lineno} )
                result = False
    def _hasContent(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:es="http://www.EcoInvent.org/EcoSpold01"', name_='TDataSetInformation', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDataSetInformation')
        if self._hasContent():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TDataSetInformation', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDataSetInformation'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type="%s"' % self.gds_format_integer(self.type_, input_name='type'))
        if self.impactAssessmentResult is not None and 'impactAssessmentResult' not in already_processed:
            already_processed.add('impactAssessmentResult')
            outfile.write(' impactAssessmentResult="%s"' % self.gds_format_boolean(self.impactAssessmentResult, input_name='impactAssessmentResult'))
        ...
        if self.internalVersion is not None and 'internalVersion' not in already_processed:
            already_processed.add('internalVersion')
            outfile.write(' internalVersion="%s"' % self.gds_format_float(self.internalVersion, input_name='internalVersion'))
        if self.energyValues is not None and 'energyValues' not in already_processed:
            already_processed.add('energyValues')
            outfile.write(' energyValues="%s"' % self.gds_format_integer(self.energyValues, input_name='energyValues'))
        ...
        if self.localLanguageCode != "de" and 'localLanguageCode' not in already_processed:
            already_processed.add('localLanguageCode')
            outfile.write(' localLanguageCode=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.localLanguageCode), input_name='localLanguageCode')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:es="http://www.EcoInvent.org/EcoSpold01"', name_='TDataSetInformation', fromsubclass_=False, pretty_print=True):
        pass
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'internalVersion' not in already_processed:
            ...
            self.validate_internalVersionType(self.internalVersion)    # validate type internalVersionType
        ...
        if value is not None and 'energyValues' not in already_processed:
            ...
            self.validate_energyValuesType(self.energyValues)    # validate type energyValuesType
        value = find_attr_value_('languageCode', node)
        if value is not None and 'languageCode' not in already_processed:
            already_processed.add('languageCode')
            self.languageCode = value
            self.validate_TISOLanguageCode(self.languageCode)    # validate type TISOLanguageCode
        ...
        if value is not None and 'localLanguageCode' not in already_processed:
            ...
            self.validate_TISOLanguageCode(self.localLanguageCode)    # validate type TISOLanguageCode
